...
<form method="get" id="proceed-book" name="form-book-proced" action="{{ route('book.store') }}" enctype="multipart/form-data">
...
@endif
 ...
 <input type="hidden" name="schedule"class="input" value="{{$schedule->id}}">
         ...
         @endforeach
         <hr>
         <h1>Who is customer</h1>
         <div class="input-checkbox">
         @foreach($seats as $seat)

            <input type="radio" name="decision" value="{{ ++$j }}" id="payments-2"  required>
            <label for="payments-2">Passanger {{ $j }}</label>

         @endforeach

            <input type="radio" name="decision" id="payments-2"  required>
            <label for="payments-2">None</label>
            <div class="caption">
                ...
                <hr>
                      ...
                      <div class="form-row form-group">
                         <div class="col">
                           <input type="text" name="customer_fn" class="input" placeholder="First name">
                         </div>
                         <div class="col">
