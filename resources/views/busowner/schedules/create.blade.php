        ...
        <div class="col-md-9 col-sm-9 col-lg-9 pull-left">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xm-12">
                ...
                <form method="post" name="form-buses" action="{{ route('schedules.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                            <label for="image">Image<span class="required" style="font-size:11px;">(optional)</span></label>
                            <input type="file" id="image" name="image" spellcheck="false" class="form-control" />
                        </div>
